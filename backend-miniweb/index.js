  ...
  if (status === 'approved') {
    res.send(`
      ...
      <html lang="es">
        ...
        <body>
          <h1>✅ Pago aprobado</h1>
          <p>Redirigiendo a instrucciones de transferencia...</p>
        </body>
      </html>
    `);
  } else {
...
// Endpoint para instrucciones de pago por transferencia (GET)
    ...
    <html lang="es">
      ...
      <body>
        <div class="container">
          ...
          <p class="info">
            Realice la transferencia bancaria a la siguiente cuenta:
            <strong>Banco: Banco Macro</strong>
            <strong>Cuenta: 1234567890</strong>
            <strong>Titular: MARQUEZ Rivero Damiana Yanina</strong>
            <strong>DNI: 37.159.913</strong>
          </p>
          <p class="info">
